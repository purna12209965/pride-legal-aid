        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/resources" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Support Resources</Link></li>
              <li><Link to="/counseling" className="text-sm text-muted-foreground hover:text-foreground transition-colors">Talk to Activist</Link></li>
            </ul>
          </div>
